...
<div className=".bg-dark">
                <button
                  class="btn btn-dark py-3 rounded-pill">
                  <i className="fa fa-shopping-basket mr-3" style={{fontSize: 20 }}></i>
                  <span className="badge badge-danger" style={{fontSize: 10 }}>{list_order_data.length}</span>
                </button>
                </div>
